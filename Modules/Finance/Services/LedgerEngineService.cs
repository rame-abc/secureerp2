    ...
    public class LedgerEngineService
    {
            ...
            LedgerState ledgerState)
        {
            ...
            try
            {
                ...
                if (financeEvent.Data.TryGetValue("JournalEntryId", out var journalEntryIdValue))
                {
                    var journalEntryId = Convert.ToInt32(journalEntryIdValue);
                }
                else
                {
                ...
                if (financeEvent.Data.TryGetValue("TransactionNumber", out var transactionNumberValue))
                {
                    var transactionNumber = transactionNumberValue?.ToString() ?? string.Empty;
                }
                else
                {
                ...
                if (financeEvent.Data.TryGetValue("TransactionDate", out var transactionDateValue))
                {
                    var transactionDate = Convert.ToDateTime(transactionDateValue);
                }
                else
                {
                ...
                if (financeEvent.Data.TryGetValue("Description", out var descriptionValue))
                {
                ...
                if (financeEvent.Data.TryGetValue("CreatedBy", out var createdByValue))
                {
                    var createdBy = createdByValue?.ToString() ?? string.Empty;
                }
                else
                {
                ...
                if (journalData.TryGetValue("JournalLines", out var journalLinesValue))
                {
                    var journalLines = JsonSerializer.Deserialize<List<JournalLineData>>(
                        journalLinesValue?.ToString() ?? "[]");
                }
                else
                {
                ...
                var journalEntry = new JournalEntry
                {
                    ...
                    TransactionDate = Convert.ToDateTime(transactionDateValue),
                    Description = descriptionValue?.ToString() ?? string.Empty,
                    Status = SecureERP2.Modules.Finance.Entities.JournalStatus.Draft,
                    CompanyId = financeEvent.CompanyId,
                    CreatedBy = createdByValue?.ToString() ?? string.Empty,
